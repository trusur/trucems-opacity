        ...
        <div class="bg-gray-300 h-[83vh] rounded-tl-3xl rounded-br-3xl">
            ...
            <form id="form-edit" action="{{ url("sensor/update/{$sensor->id}") }}" method="PATCH"
                ...
                <div class="w-1/2">
                    <div class="flex my-2 justify-between items-center">
                        <span class="w-1/3">
                            <span class="uppercase font-semibold text-xl">Reading Formula</span>
                        </span>
                        <span class="w-2/3">
                    ...
                    <div class="flex my-2 justify-between items-center">
                        <span class="w-1/3">
                            <span class="uppercase font-semibold text-xl">Write Address</span>
                        </span>
                        <span class="w-2/3">
                            <input type="text" required name="write_address" data-kioskboard-type="keyboard"
                                data-kioskboard-specialcharacters="true" data-kioskboard-placement="bottom"
                                value="{{ $sensor->write_address }}"
                                class="js-virtual-keyboard rounded px-3 py-2 h-14 text-2xl outline-none w-full">
                        </span>
                    </div>
